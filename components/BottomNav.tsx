...
<div className="flex h-[var(--bottom-nav-h)] items-center justify-between rounded-2xl border border-warm bg-[color:var(--surface)]/80 backdrop-blur-lg shadow-soft px-4"          {items.map((it) => {
